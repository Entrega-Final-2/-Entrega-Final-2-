    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _mysql["default"].query("CALL SP_MOSTRAR_PRODUCTO(\"".concat(id, "\");"));
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _mysql["default"].query("CALL SP_LISTAR_PRODUCTO ();");
        case 3:
...
var crearProducto = exports.crearProducto = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, producto, descripcion, respuesta;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$body = req.body, producto = _req$body.producto, descripcion = _req$body.descripcion;
          _context3.prev = 1;
          _context3.next = 4;
          return _mysql["default"].query("CALL SP_CREAR_PRODUCTO (\"".concat(producto, "\", \"").concat(descripcion, "\")"));
        case 4:
          respuesta = _context3.sent;
          res.json({
            "respuesta": "el producto ha sido creado"
          });
          _context3.next = 11;
          break;
        case 8:
          ...
          res.json({
            "error": "el producto no ha sido creado"
          });
        case 11:
        case "end":
...
var modificarProducto = exports.modificarProducto = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, id, producto, descripcion, respuesta;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, id = _req$body2.id, producto = _req$body2.producto, descripcion = _req$body2.descripcion;
          _context4.prev = 1;
          _context4.next = 4;
          return _mysql["default"].query("CALL SP_MODIFICAR_PRODUCTO (\"".concat(id, "\", \"").concat(producto, "\", \"").concat(descripcion, "\");"));
        case 4:
        ...
        case 8:
          ...
          res.json({
            "respuesta": "el producto no ha sido modificado"
          });
        case 11:
        case "end":
